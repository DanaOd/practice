...
//Саша посоветовал тернарник сдвинуть чтобы не повторять то же самое // повторить !!
//[item]: acc[item] ? - проверка существует ли там что-то, или там 0/undefined ==тогда выполнится 2я часть условия
const tagsStat = allTags.reduce((acc, item)=>{
    console.log(acc);
